    ...
    <div class="container">      
        <div class="row">
            <div class="col-xs-12 col-sm-9 col-md-7 col-lg-6">           
                <form role="form" action="../controlador/registrar_perfil.php" method="post" onsubmit="return validar_registro_usuario()" >
                    ...
                    <div class="form-group row">  
                        <div class="col-xs-12">                      
                            <button type="submit" class="btn btn-primary btn-md btn-block">Registrarme</button>
                        </div>
                    </div>
                </form>
            </div>
